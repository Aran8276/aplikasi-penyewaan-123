      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div className="flex flex-col gap-4">
          <h1 className="text-xl font-semibold">
            Kabel Data 4 in 1 65W 27W Fast Charging PD TYPE C to C - Kabel Casan
            4in1 C to Lightning USB to C USB to Lightning
          </h1>
          ...
          <div>
            <p>
              ...
              ullam necessitatibus. Dicta iste molestiae quis ad ut recusandae
              facilis eum nostrum magnam, hic ipsa qui, eius eveniet.
              Laudantium, error voluptatum!
            </p>
          </div>
          ...
          <Card>
            <CardContent className="p-4">
              ...
              <p>
                <span className="font-semibold">Etalase:</span> Kabel Data
              </p>
            </CardContent>
          </Card>
